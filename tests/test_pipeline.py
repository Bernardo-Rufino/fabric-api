...
from fabric_api.pipeline import Pipeline
...
class TestGetPipeline:
    ...
    @patch('fabric_api.pipeline.requests.request')
...
class TestResolveDataflowId:
    ...
    @patch('fabric_api.pipeline.Dataflow')
...
class TestGetPipelineActivities:
    ...
    @patch('fabric_api.pipeline.Dataset')
    @patch('fabric_api.pipeline.Notebook')
    @patch('fabric_api.pipeline.Dataflow')
    @patch('fabric_api.pipeline.requests.request')
...
class TestPipelineRetry:
    ...
    @patch('fabric_api.pipeline.time.sleep')
    @patch('fabric_api.pipeline.requests.request')
